        ...
        <div class="columns large-6 large-offset-6 medium-6 medium-offset-6">
          ...
          <div class="coll-single">
            <div class="title-wrapper">
              <ul class="icons">
                <li><a class="link" target="_blank" href="https://twitter.com/Jon_E_Johnson">
      ...
      <div class="row ">
        <div class="columns large-6 medium-6">
          ...
          <div class="coll-single">
            <div class="title-wrapper">
              <ul class="icons">
                <li><a class="link" target="_blank" href="https://twitter.com/TravisBlanton">
                    <i class="fa fa-twitter"></i> </a></li>
      ...
      <div class="row ">
        <div class="columns large-6 large-offset-6 medium-6 medium-offset-6">
          ...
          <div class="coll-single">
            <div class="title-wrapper">
              <ul class="icons">
                <li><a class="link" target="_blank" href="https://twitter.com/PhisterSister1">
                    <i class="fa fa-twitter"></i> </a></li>
                <li><a class="link" target="_blank" href="http://www.linkedin.com/pub/melanie-brown/5/767/8a0">
                    <i class="fa fa-linkedin"></i></a></li>
