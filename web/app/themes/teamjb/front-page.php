<div id="skrollr-body" role="main" class="wrapper common">
    <section id="intro-hn" class="post-836 coll-page-section type-coll-page-section status-publish hentry page-section coll-full-width js-coll-window">
        <div class="coll-section-background js-coll-parallax" style="background-color: #000000">
            <div class="coll-bg-video coll-to-mute">              
                <div class="video" style="width: 1920px; height: 1080px; overflow: hidden; position: relative;"><iframe frameborder="0" scrolling="no" seamless="seamless" webkitallowfullscreen="webkitAllowFullScreen" mozallowfullscreen="mozallowfullscreen" allowfullscreen="allowfullscreen" id="okplayer" src="//player.vimeo.com/video/122100167?title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff&amp;autoplay=1&amp;loop=1&amp;api=1" width="1920" height="1080" style="position: absolute; top: 0px; left: 0px; width: 1920px; height: 1080px;"></iframe></div>
            </div>
        ...
        <div class="section-content row ">
            <div class="columns entry-title coll-hide-title">
                <h2 class="title" style="color: #fff">intro hn</h2>
            ...
            <div class="entry-content columns">
                ...
                <p style="text-align: center;">
                    <a style="border-radius : 4px; -moz-border-radius:4px; -webkit-border-radius4px;"
                       ...
                       data-coll-background-color-hover="#ffffff">Discover</a>
                </p>
            </div>
        </div>
    </section>
    ...
    <section id="twitter-ex2" class="post-829 coll-page-section type-coll-page-section status-publish hentry page-section ">
        <div class="coll-section-background js-coll-parallax" style="background-color: #F1B950">
            ...
            <div class="coll-bg-video-overlay"></div>
            <div class="overlay" style="background-color: #000000;opacity:0.7">
            </div> -->
        </div>
        <div class="section-content row">
            <div class="columns entry-title coll-hide-title">
                <h2 class="title" style="color: #fff">twitter ex2</h2>
                <h4 class="subtitle" style="color: #fff"></h4>
            </div>
            <div class="entry-content columns">
                <div class="coll-twitter "
                    ...
                    <ul class="logo">
                        <li class="left"></li>
                        <li class="center"><i class="fa fa-twitter"></i></li>
                        <li class="right"></li>
                    </ul>
                    <div id="twitter-5372" class="tweets-slider coll-flexslider flexslider">
                        <ul class="slides"></ul>
                    </div>
                </div>
            </div>
