        ...
        if (self.isMobile) {
            ...
            $(".wrapper.common").swipe({
                ...
                swipeStatus: function (event, phase, direction, distance, duration, fingerCount) {
                    ...
                    if (phase === 'start') {
                        _mHeaderPos = _mHeader.offset().top;
                    }
...
//    // Module variables
//    self.$window = $(window);
//    self.isMobile = $('body').hasClass('coll-mobile') ? true : false;
//    
//    // Kick everything off...
//    self.init = function() {
//        console.log('Common module initialized.');
//     
//        // Get a hold of modules we'll need
//        var preloader = new self.Preloader();
//        var header = new self.Header();
//        
//        // Start preloading
//        preloader.init();     
//     
